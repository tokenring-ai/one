  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      <div className="shrink-0 px-6 pt-5 pb-4 border-b border-primary space-y-4">
        ...
        <div>
          <label htmlFor="edit-post-title" className="text-2xs font-semibold text-muted uppercase tracking-wider block mb-1">
            Title
          </label>
          <input
            id="edit-post-title"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label htmlFor="edit-post-status" className="text-2xs font-semibold text-muted uppercase tracking-wider block mb-1">
              Status
            </label>
            <select
              id="edit-post-status"
          ...
          <div>
            <label htmlFor="edit-post-tags" className="text-2xs font-semibold text-muted uppercase tracking-wider block mb-1">
              Tags
            </label>
            <input
              id="edit-post-tags"
      ...
      <div className="flex-1 overflow-y-auto px-6 py-4">
        <label htmlFor="edit-post-html" className="text-2xs font-semibold text-muted uppercase tracking-wider block mb-1">
