  ...
  return (
    ...
    >
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-1 p-2">
        ...
        <span className="text-xs text-muted truncate max-w-full px-1 font-mono">{audio.filename}</span>
        {audio.duration !== undefined && <span className="text-xs text-muted opacity-70">{formatDuration(audio.duration)}</span>}
      </div>
